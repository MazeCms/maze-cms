<?php
namespace plg\system\compressor\lib;
use RC;
/**
 ...
 * 
 */
class CssUriRewriter extends \maze\base\Object {
    ...
    public function getCurrentDir() {
        if ($this->_currentDir === null)
            $this->_currentDir = str_replace(RC::getAlias("@root"), "", pathinfo($this->_file, PATHINFO_DIRNAME)) ;
