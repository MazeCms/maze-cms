...
use maze\base\View;
use yii\base\Widget;
use maze\base\ViewRenderer as BaseViewRenderer;
...
class ViewRenderer extends BaseViewRenderer
{
     ...
     */
    public $extensionClass = '\lib\smarty\Extension';
    ...
    public function init()
    {
        ...
        $this->smarty->setCompileDir(RC::getAlias($this->compilePath));
        $this->smarty->setCacheDir(RC::getAlias($this->cachePath));
        ...
        $this->smarty->setTemplateDir([
            dirname(RC::$app->getView()->getViewFile()),
            RC::$app->getViewPath(),
        ]);
