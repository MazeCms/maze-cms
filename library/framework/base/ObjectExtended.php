...
class  ObjectExtended extends Object
{
    ...
    public function __set($name, $value)
    {
        ...
        if (method_exists($this, $setter)) {
            ...
            $this->attachBehavior($name, $value instanceof Behavior ? $value : RC::createObject($value));
     ...
     *  - an object configuration array that will be passed to [[RC::createObject()]] to create the behavior object.
     *
    ...
    private function attachBehaviorInternal($name, $behavior)
    {
        if (!($behavior instanceof Behavior)) {
            $behavior = RC::createObject($behavior);
        }
        if (is_int($name)) {
