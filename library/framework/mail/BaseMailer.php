...
use maze\base\ViewContextInterface;
use maze\base\View;
 ...
 *
 */
abstract class BaseMailer extends Object implements MailerInterface, ViewContextInterface
{
     ...
     */
    public $htmlLayout = '@tmp/system/mail/html';
    /**
     ...
     */
    public $textLayout = '@tmp/system/mail/text';
    /**
     ...
     */
    public $messageClass = 'maze\mail\BaseMessage';
    /**
     ...
     */
    public $fileTransportPath = '@site/temp/mail';
    /**
    ...
    /**
     * @var \maze\base\View|array view instance or its array configuration.
     */
    private $_view = [];
    /**
    ...
    public function send($message)
    {
        ...
        if(!$message->getFrom()){
            $conf = RC::getConfig();
            $message->setFrom($conf->mailfrom, $conf->site_name);
        }
    ...
    {
        $path = RC::getAlias($this->fileTransportPath);
        if (!is_dir(($path))) {
     ...
     * Defaults to '@exp/exp_component/mail'.
     */
    public function getViewPath()
    {
        if ($this->_viewPath === null) {
            $this->setViewPath(RC::getAlias('@exp/exp_' . RC::app()->router->component . '/mail'));
        }
    ...
    {
        $this->_viewPath = RC::getAlias($path);
    }
