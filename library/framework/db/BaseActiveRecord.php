 ...
 */
abstract class BaseActiveRecord extends \maze\base\Model implements ActiveRecordInterface
{
    ...
    public function getRelation($name, $throwException = true)
    {
        ...
        try {
            ...
            if ($throwException) {
                throw new \Exception(get_class($this) . ' has no relation named "' . $name . '".', 0, $e);
            } else {
                return null;
            }
        }
        ...
        if (method_exists($this, $getter)) {
            ...
            if ($realName !== $name) {
                if ($throwException) {
                    throw new \Exception('Relation names are case sensitive. ' . get_class($this) . " has a relation named \"$realName\" instead of \"$name\".");
                } else {
                    return null;
                }
            }
    ...
    private function bindModels($link, $foreignModel, $primaryModel)
    {
        foreach ($link as $fk => $pk) {
            ...
            if ($value === null) {
                throw new \Exception('Unable to link models: the primary key of ' . get_class($primaryModel) . ' is null.');
            }
