...
class RequiredValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = $this->requiredValue === null ? 'LIB_FRAMEWORK_VALIDATOR_REQUIRED_EMPTY'
                : 'LIB_FRAMEWORK_VALIDATOR_REQUIRED_VAL';
        }
    }
    ...
    public function clientValidateAttribute($object, $attribute)
    {
        ...
        $options['message'] = \Text::_($options['message'], ['attribute' => $object->getAttributeLabel($attribute)]);


        return ['validate'=>'required',  'options'=>$options];
    }
}
