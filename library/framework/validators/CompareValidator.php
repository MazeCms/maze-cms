...
class CompareValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            switch ($this->operator) {
                case '==':
                    $this->message = 'LIB_FRAMEWORK_VALIDATOR_COMPARE_REPEATED';
                    break;
                case '===':
                    $this->message = 'LIB_FRAMEWORK_VALIDATOR_COMPARE_REPEATED';
                    break;
                case '!=':
                    $this->message = 'LIB_FRAMEWORK_VALIDATOR_COMPARE_EQUAL".';
                    break;
                case '!==':
                    $this->message = 'LIB_FRAMEWORK_VALIDATOR_COMPARE_EQUAL';
                    break;
                case '>':
                    ...
                    break;
                case '>=':
                    $this->message = 'LIB_FRAMEWORK_VALIDATOR_COMPARE_EQUALTO';
                    break;
                case '<':
                    $this->message = 'LIB_FRAMEWORK_VALIDATOR_COMPARE_LESS';
                    break;
                case '<=':
                    $this->message = 'LIB_FRAMEWORK_VALIDATOR_COMPARE_OREQUALTO';
                    break;
                default:
    ...
    public function validateAttribute($object, $attribute)
    {
        ...
        if (is_array($value)) {
            $this->addError($object, $attribute, 'LIB_FRAMEWORK_VALIDATOR_INVALID');
    ...
    public function clientValidateAttribute($object, $attribute)
    {
        ...
        $options['message'] = \Text::_($this->message, [
        ...
        return ['validate'=>'compare',  'options'=>$options];
    }
}
