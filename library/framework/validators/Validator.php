...
class Validator extends Object
{
    ...
    public static $builtInValidators = [
        'boolean' => 'maze\validators\BooleanValidator',
        'compare' => 'maze\validators\CompareValidator',
        'date' => 'maze\validators\DateValidator',
        'default' => 'maze\validators\DefaultValueValidator',
        'double' => 'maze\validators\NumberValidator',
        'email' => 'maze\validators\EmailValidator',
        'exist' => 'maze\validators\ExistValidator',
        'file' => 'maze\validators\FileValidator',
        'filter' => 'maze\validators\FilterValidator',
        'image' => 'maze\validators\ImageValidator',
        'in' => 'maze\validators\RangeValidator',
        'integer' => [
            'class' => 'maze\validators\NumberValidator',
            'integerOnly' => true,
        ],
        'match' => 'maze\validators\RegularExpressionValidator',
        'number' => 'maze\validators\NumberValidator',
        'required' => 'maze\validators\RequiredValidator',
        'safe' => 'maze\validators\SafeValidator',
        'string' => 'maze\validators\StringValidator',
        'trim' => [
            'class' => 'maze\validators\FilterValidator',
            'filter' => 'trim',
        ],
        'unique' => 'maze\validators\UniqueValidator',
        'url' => 'maze\validators\UrlValidator',
    ];
    ...
    public function addError($object, $attribute, $message, $params = [])
    {
        ...
        $object->addError($attribute, \Text::_($message, $params));
    }
