...
class FormField extends Object {
    ...
    /**
     * @var array the $errorOptions - настройки блока вывода ошибки
     */
    ...
    /**
     * @var boolean $enableClientValidation -  разрешить проверять атрибут
     */
...
// use trigger_error to bypass this limitation
    ...
    public function render($content = null) {
        if ($content === null) {
            ...
            if (!isset($this->parts['{error}'])) {
                $this->errorOptions['id'] = Html::getInputId($this->model, $this->attribute)."_message";
    ...
    public function begin() {
        ...
        if (!empty($clientOptions)) {
            $this->form->attributes  = array_merge($this->form->attributes, $clientOptions);
        }
...
// https://github.com/yiisoft/yii2/pull/795
    ...
    /**
     * Получить валидатор клиента текущего атрибута
    ...
    protected function getClientOptions() {
        ...
        if ($enableClientValidation) {
            ...
            foreach ($this->model->getActiveValidators($attribute) as $validator) { 
                ...
                $jsValid = $validator->clientValidateAttribute($this->model, $attribute);
          
        
                if ($validator->enableClientValidation &&  !empty($jsValid)) {                    
                    $jsValid['elem'] = '#'.Html::getInputId($this->model, $this->attribute);
                    $validators[] = $jsValid;
                }
            }
        }
