...
$grid->setPlugin("contextmenu", [
    "menu" => [
        ...
        "data" => [
            array("type" => 'link', "spriteClass" => 'menu-icon-edits', "href" => Route::_([['run' => 'edit', 'bundle' => '{++bundle++}', 'mode'=>0, 'expansion'=>'dictionary']]), "title" => Text::_("EXP_CONTENTS_EDIT")),
            array("type" => 'link', "spriteClass" => 'menu-icon-trash', "href" => Route::_([['run' => 'delete', 'bundle' => ['{++bundle++}'], 'mode'=>0, 'expansion'=>'dictionary']]), "title" => Text::_("EXP_CONTENTS_DELETE")),
        ]]
]);
