...
<script>
    jQuery().ready(function () {
        $('#contenttypeview-field_view').change(function () {
            cms.redirect([{
                    field_view: $(this).val()
                }]);
        })
...
$form = FormBuilder::begin([
            'ajaxSubmit' => true,
            'id' => 'contents-field-view-settings',
...
<div class="row">
    <div class="col-sm-8 col-md-8">
        <?= $form->field($modelView, 'view_name')->textInput(['disabled' => ($modelView->scenario !== 'create')]); ?>

    </div>
    <div class="col-sm-4 col-md-4">
        <?= $form->field($modelView, 'group_name'); ?>
    </div>
</div>
