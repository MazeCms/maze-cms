<?php
namespace admin\expansion\exp_elfinder\classes;

defined('_CHECK_') or die("Access denied");
use admin\expansion\exp_elfinder\classes\elFinderVolumeDriver;
/**
...
class elFinderVolumeLocalFileSystem extends elFinderVolumeDriver {
    ...
    protected function _checkArchivers() {
        /**
         * Дополнительные проверки на выключенные функции
         */
        ...
        if (!function_exists('exec') || !function_exists('proc_open') || in_array('exec',$disabled) ||  in_array('proc_open',$disabled) ) {
