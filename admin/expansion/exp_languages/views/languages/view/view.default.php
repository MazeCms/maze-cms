...
class Languages_View_Languages extends View {
    ...
    public function registry() {
        ...
        RC::app()->breadcrumbs = ['label' => "EXP_LANGUAGES_TITLE"];
        ...
        $toolbar->addGroup('lang', [
            ...
            "SORT" => 10,
            "HREF" => [['run' => 'add']],
            "VISIBLE" =>$this->_access->roles("languages", "EDIT_LANG"),
            "SORTGROUP" => 10,
        ...
        $toolbar->addGroup('lang', [
            ...
            "MENU" => [
                [
                    ...
                    "ACTION" => "return cms.btnGridAction('#languages-grid', this.href)"
                ],
                [
                    "class" => 'ContextMenu',
         ...
         $toolbar->addGroup('lang', [
            ...
            "TYPE" => Buttonset::BTNMIN,
            "SORT" => 7,
            "VISIBLE" => $this->_access->roles("languages", "DELET_LANG"),
            "HREF" => [['run' => 'delete']],
            "SORTGROUP" => 10,
            "SRC" => "/library/jquery/toolbarsite/images/icon-trash.png",
            "ACTION" => "return cms.btnGridActionPromt('#languages-grid', this.href)"
        ]);
